...
public class GameManager : MonoBehaviour
{
    ...
    private void ShowPoints() {
        for(int i=0;i<4;i++) {
            ...
            AboveHeadCanvas.transform.GetChild(i).transform.GetChild(0).GetComponent<Text>().text = Players.transform.GetChild(i).GetComponent<PointSystemPai>().VirtualPoints.ToString();
